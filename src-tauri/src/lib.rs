...
use commands::{
    ...
    get_github_app_config_command, get_github_auth_method_command, get_github_status, get_project,
    ...
    get_workspace, get_workspace_file_path, install_self_hosted_runner, list_github_environments,
    list_github_repos, list_github_secrets, list_github_variables, list_projects,
    list_supported_providers, list_vms, parse_github_repo_url_command, poll_github_device_token,
    preview_list_vms, register_github_app_command, restart_project, rotate_runner_registration,
    save_credentials, save_github_pat_command, save_provider_credentials,
    save_ssh_credentials_command, save_workspace_command, start_github_device_flow, start_project,
    stop_project, sync_env_profile_to_github_secrets, test_connection, test_github_connection,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            connect_github_from_gh_cli,
            get_github_app_config_command,
            register_github_app_command,
